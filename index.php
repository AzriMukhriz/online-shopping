...
<head>
    ...
    <title>Online Shopping System</title>
	 <link rel="shortcut icon" href="assets/img/l3.png" type="image/x-icon" />
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/l4.png" alt=""  /></a>
            </div>
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE ONLINE SHOPPING SYSTEM <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
         ...
         <div id="testimonials-sec" class="container set-pad" >
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/profile4.jpeg" style="width:100px;height:100px;" />
                   <h3 >Hakimi Rodriguez</h3>
                 <hr />
                       <hr />
                   <p >
                       This company is one of the best in the market they have the best t-shirt and trousers.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  >Contractor Worker</a>
                </div>
                   </div>
				   ...
				   <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/profile7.jpg" style="width:100px;height:100px;" />
                   <h3 >Tony <br />Muqri</h3>
                 <hr />
                       <hr />
                   <p >
                       I love the jersey that they have here, the quality used really feels premium and it gives me an extra boost during the SEA Games.
                   </p>
				   </center>
				   <br />
               <a class="btn btn-info btn-set"  >Petanque SEA Games Champion</a>
                </div>
                   </div>
				    ...
				    <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/profile8.jpeg" style="width:100px;height:100px;" />
                   <h3 >Izzul <br /> Edwards</h3>
                 <hr />
                       <hr />
                   <p >
                      The gadgets sold here are peticularly reliable and it supports 5G which is a good thing.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  >Youtuber</a>
                </div>
                   </div>
                 
				 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/profile6.jpeg" style="width:100px;height:100px;" />
                   <h3 >Luan <br />Fizi</h3>
                 <hr />
                       <hr />
                     <p>They deliver quite fast and the price of the items are reasonable compared to many other online platforms I've used.</p>

				   </center>
				   <br />
				   <br />
               <a class="btn btn-info btn-set"  >University Student</a>
                </div>
                   </div>
   ...
   <!-- FEATURES SECTION END-->
    ...
    <div class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">Site Developers</h1>
                     <p data-scroll-reveal="enter from the bottom after 0.3s">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="assets/img/profile5.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >AZRI "ZEDDY" MUKHRIZ</h3>
                 <hr />
                         <h4>BSIT<br />ICE Department</h4>
                   <p >
                       Zeddy, is the designer of this site. 
					   He studied at Davao Oriental State College of Science and Technology (DOSCST) and taking up Bachelor of Science in Information Technology (BSIT). 
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                       <img src="assets/img/profile3.jpeg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >ANIQ A. CAESAR</h3>
                 <hr />
                       <h4>BSIT<br />ICE Department</h4>
                   <p >
                       Caezar , is the developer of this site. 
					   He studied at Davao Oriental State College of Science and Technology (DOSCST) and taking up Bachelor of Science in Information Technology (BSIT). 
					   He specialized in Web Development.
...
<div class="container">
           <div class="row" >
                    ...
                    <img class="img img-rounded img-responsive" src="assets/img/brands1.jpg"  style="width:2000px;height:500px;"/>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div ">
                        <h4>No. 220 Cengal 2, UiTM Kampus Arau, Arau</h4>
        ...
        <hr />
                    <div >
                        ...
                        <h4><strong>Email: </strong>onlineshoppingsyso@gmail.com</h4>
                    </div>
                    </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2022 Online Shopping | All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : Online Shopping Team</a>
    </div>
     <!-- FOOTER SECTION END-->
